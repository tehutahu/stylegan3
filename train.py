...
@click.option('--calc',         help='How often to calculate metrics', metavar='TICKS',         type=click.IntRange(min=1), default=50, show_default=True)
...
def main(**kwargs):
    ...
    c.calc_metrics_ticks = opts.calc
